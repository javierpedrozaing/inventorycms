     ...
     <div class="panel panel-default">
       <div class="panel-heading">
        <strong>
          ...
          <!--ACtualizar <?#php echo remove_junk(ucwords($e_user['name'])); ?> Account -->
          Actualizar cuenta
        </strong>
       </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          <!--Change <?#php echo remove_junk(ucwords($e_user['name'])); ?> contraseña -->
      ...
      <div class="panel-body">
        <form action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          ...
          <div class="form-group clearfix">
                  <button type="submit" name="update-pass" class="btn btn-danger pull-right">Actualizar</button>
          </div>
        </form>
      </div>
    </div>
